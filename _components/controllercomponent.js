...
CARNIVAL.registerComponent('net.meta4vr.vrui.sys.controller.vive_lowpoly', function () {
    ...
    var ControllerChrome = function (params, behaviours) {
        ...
        if (p.texture) {
            ctrl.texture = p.texture;
            ctrl.textureLabel = null;
        }
        else {
        ...
        for (var i = 0; i < parts.length; i++) {
            ...
            var piececfg = {
                materialLabel: ctrl.materialLabel,
                textureLabel: !ctrl.texture && ((i==0 && ctrl.textureLabel) || ctrl.altTextureLabel),
                texture: ctrl.texture
            };

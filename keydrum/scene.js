...
- Having an individual drawable for every single keycap is just wrong.
...
/*            updateReadout('C', rectTR);                                   */
        ...
        */
        ...
        /* Update status cube */
        if (!(collider.bracketDistanceMin <= pointOfInterest && pointOfInterest <= collider.bracketDistanceMax)) return; 
